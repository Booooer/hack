    ...
    <div class="profile-info">
        ...
        <div class="profile-role">
            ...
            <form action="{{route('logout')}}" method="POST">
                @csrf
                <button type="submit" class="profile button" value="выйти">выйти</button>
            </form>
        </div>
    </div>
...
=======
            @if($user->role == 'admin')
>>>>>>> 882fdedfdf864053ad24fe706ac5a1f8c594ee56
...
=======
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" name="login" value="{{$user->login}}">{{$user->login}}
                </div>
                </td>
                <td>
                    <div id="{{$user->role}}">{{$user->role}}</div>
